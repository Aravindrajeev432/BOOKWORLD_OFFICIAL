    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zipcode', models.CharField(default='000000', max_length=30)),
                ('order_total', models.FloatField()),
                ('shipping_charge', models.FloatField()),
                ('status', models.CharField(choices=[('Processing', 'Processing'), ('Shipped', 'Shipped'), ('Deliverd', 'Deliverd'), ('Cancelled', 'Cancelled')], default='Processing', max_length=10)),
